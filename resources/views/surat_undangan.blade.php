<x-layoutsurat>
  ...
  <div class="font-style" id="Isi Surat" style="margin-left: 17.4%">
    ...
    <p class="margin-text">Dalam kesempatan ini, kami dari Himpunan Mahasiswa Jurusan Teknologi Informasi bermaksud mengundang Bapak/Ibu/Saudara/Saudari untuk hadir dan berpartisipasi dalam kegiatan <strong>{{ $data->nama_kegiatan }}</strong>. Kegiatan ini bertujuan untuk {{ $data->tujuan_kegiatan }}.</p>
